...
CREATE TABLE IF NOT EXISTS POSTAGENS  (
	...
	PRIMARY KEY (id),
	FOREIGN KEY (USUARIOS_usuario) REFERENCES USUARIOS(usuario) ON DELETE CASCADE, 
	FOREIGN KEY (MURAIS_id) REFERENCES MURAIS(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS PRESENCAS  (
	...
	FOREIGN KEY (EVENTOS_POSTAGEM_id) REFERENCES EVENTOS(POSTAGEM_id) ON DELETE CASCADE,
	FOREIGN KEY (USUARIOS_usuario) REFERENCES USUARIOS(usuario)	ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS CIRCULO_INTERESSES (
	USUARIOS_usuario VARCHAR(200) NOT NULL,
	MURAIS_id INT NOT NULL,
	FOREIGN KEY (USUARIOS_usuario) REFERENCES USUARIOS(usuario) ON DELETE CASCADE,
	FOREIGN KEY (MURAIS_id) REFERENCES MURAIS(id) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS MENCOES (
	POSTAGEM_id INT NOT NULL,
	USUARIOS_usuarioMencionado VARCHAR(200) NOT NULL,
	FOREIGN KEY (POSTAGEM_id) REFERENCES POSTAGENS(id) ON DELETE CASCADE,
	FOREIGN KEY (USUARIOS_usuarioMencionado) REFERENCES USUARIOS(usuario) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS PRESENCAS_EVENTO (
	POSTAGEM_id INT NOT NULL,
	USUARIOS_usuario VARCHAR(200) NOT NULL,
	FOREIGN KEY (POSTAGEM_id) REFERENCES EVENTOS(POSTAGEM_id) ON DELETE CASCADE,
	FOREIGN KEY (USUARIOS_usuario) REFERENCES USUARIOS(usuario) ON DELETE CASCADE
);